...
function sortByName(employees) {
    return employees.sort(function (a, b) { return (a.EmployeeName > b.EmployeeName) ? 1 : (a.EmployeeName < b.EmployeeName) ? -1 : 0; });
}
function groupByDepartment(employees, propertyName) {
    return employees.reduce(function (i, j) {
